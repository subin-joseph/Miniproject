...
.css-button:hover {
	background:background: linear-gradient(180deg, #ce0000 5%, #fe1900 100%);;
	  color:#FFFFFF;
}
.css-button-icon {
	padding: 10px 10px;
    ...
    <main class="mt-5 pt-3">
      <div class="container-fluid">
        ...
        <div class="row">
		 ...
		 <div id="btngrp">
<a class="css-button" href="inact_voter_excel.php">
...
<tbody>
 ...
 <?php
 $sql = "SELECT * from tbl_voters where status=0";
