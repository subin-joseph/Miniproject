...
header("Content-type: application/vnd.ms-excel");
  header("Content-Disposition: attachment; filename=inactive_voters_List.xls" );
  header("Expires: 0");
...
<table>
  ...
  <tbody>
    <?php 
    $qryreport = mysqli_query($conn,"SELECT * from tbl_Voters where status=0") or die(mysqli_error());
