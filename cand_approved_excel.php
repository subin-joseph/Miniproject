...
header("Content-type: application/vnd.ms-excel");
  header("Content-Disposition: attachment; filename=Approved_candidates.xls" );
  header("Expires: 0");
...
<table>
  ...
  <tbody>
    <?php 
    $qryreport = mysqli_query($conn,"SELECT * from tbl_candidate where status=2") or die(mysqli_error());
