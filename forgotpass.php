    ...
    if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM tbl_login WHERE email='{$email}'")) > 0) {
        ...
        if ($query) {        
            ...
            try {
                ...
                $mail->Body    = 'Here is the verification link <b><a href="http://localhost/vote-system/changepassword.php?reset='.$code.'">http://localhost/vote-system/changepassword.php?reset='.$code.'</a></b>';
